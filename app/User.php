...
class User extends Authenticatable
{
    ...
    //Essa função retorna os usuários que eu sigo, retorna o meu id e os ids de quem eu sigo
    public function amigos()
    {
        return $this->belongsToMany('App\User', 'amigos', 'user_id', 'amigo_id');
    }

    //Esta função retorna as pessoas que me segue, retorna todos os ids relacionado ao meu id
